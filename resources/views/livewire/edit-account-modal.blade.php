                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="w-full text-center sm:text-left">
                            ...
                            <form wire:submit.prevent="update" class="space-y-5">
                                    ...
                                    <div class="relative">
                                        ...
                                        <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-pink-500 transition">
                                            ...
                                            <svg x-show="show" x-cloak class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.025 10.025 0 014.132-5.411m0 0L21 21m-21-21l21 21m-8.508-6.852A3 3 0 0010 10m3.875 3.875A3 3 0 0110 10z"></path>
                                            </svg>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-emerald-500 transition">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.812a4 4 0 005.656 0l4-4a4 4 0 10-5.656-5.656l-1.1 1.1"></path>
                                            </svg>
                                        </div>
                                ...
                                <div class="relative group">
                                    <label class="block text-xs font-bold uppercase text-gray-500 dark:text-gray-400 tracking-wider mb-1.5 pl-1">
                                        Notes <span class="text-gray-400 dark:text-gray-600 font-medium">(Optionnel)</span>
                                    </label>
                                    <div class="relative">
                                        <div class="pointer-events-none absolute top-3 left-0 flex items-start pl-4 text-gray-400 group-focus-within:text-indigo-500 transition">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <textarea wire:model="notes" rows="3"
                                            ...
                                            class="w-full pl-11 pr-4 py-3 rounded-xl resize-none
                   bg-gray-100 dark:bg-gray-800/50
                   border border-gray-200 dark:border-gray-700
                   text-gray-900 dark:text-white placeholder-gray-400
                   focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500
