...
.sidebar-sticky::-webkit-scrollbar-thumb { background: rgba(99,102,241,.25); border-radius: 4px; }
...
.gauge-arc { animation: strokeIn .9s .3s ease both; }
...
.bar-anim { animation: barGrow .8s ease both; }

/* Card hover lift */
.account-card { transition: transform .35s cubic-bezier(.34,.9,.64,1), box-shadow .35s ease; }
.account-card:hover { transform: translateY(-4px) scale(1.01); }
