...
══════════════════════════════════════════════════════ --}}
    <div class="min-h-screen bg-gradient-to-br from-gray-100 via-indigo-50 to-purple-100
        ...
        class="ml-auto p-2 rounded-xl bg-gray-100/50 dark:bg-gray-800/50 text-gray-400 
               hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 
               transition-all duration-200 border border-transparent hover:border-indigo-200/50"
        title="Modifier">
